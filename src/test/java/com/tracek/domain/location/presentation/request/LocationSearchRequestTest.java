...
class LocationSearchRequestTest {
    ...
    void toQuery_defaultsSizeWhenNull() {
        LocationSearchRequest request = new LocationSearchRequest("경복궁", 10L, null);
    ...
    void toQuery_defaultsSizeWhenLessThanOne() {
        LocationSearchRequest request = new LocationSearchRequest("경복궁", 10L, 0);
    ...
    @Test
    @DisplayName("keyword/lastLocationId/size를 그대로 Query에 전달한다")
    void toQuery_passesFieldsThrough() {
        LocationSearchRequest request = new LocationSearchRequest("경복궁", 10L, 5);
