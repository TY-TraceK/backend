...
class VisitVerificationHistoriesIndividualResultTest {
    ...
    void from_success() {
        ...
        VisitVerificationView.ArtistView artist =
                VisitVerificationView.ArtistView.builder().artistId(10L).artistName("유재석").build();
        ...
        assertThat(result.locationImageUrl()).isEqualTo("https://example.com/location.jpg");
        ...
        assertThat(result.artists().getFirst().artistId()).isEqualTo(10L);

        assertThat(result.artists().getFirst().artistName()).isEqualTo("유재석");

        assertThat(result.visitVerifiedDate()).isEqualTo(verifiedDate);

        assertThat(result.visitVerifiedTimeAt()).isEqualTo(verifiedAt);
    ...
    void from_notLikedAndNotArchived() {
        ...
        VisitVerificationView view =
                VisitVerificationView.builder()
                        ...
                        .visitVerifiedTimeAt(LocalDateTime.of(2026, 9, 18, 12, 0))
                        .visitVerificationStatus(VisitVerificationStatus.VALID)
                        .liked(false)
                        .archived(false)
                        .build();
    ...
    void from_multipleArtists() {
        ...
        VisitVerificationView view =
                VisitVerificationView.builder()
                        ...
                        .visitVerifiedDate(LocalDate.of(2026, 9, 18))
                        .visitVerifiedTimeAt(LocalDateTime.of(2026, 9, 18, 15, 0))
                        .visitVerificationStatus(VisitVerificationStatus.VALID)
                        .liked(true)
                        .archived(false)
                        .build();
        ...
        assertThat(result.artists().get(0).artistId()).isEqualTo(1L);

        assertThat(result.artists().get(0).artistName()).isEqualTo("ARTIST_1");

        assertThat(result.artists().get(1).artistId()).isEqualTo(2L);

        assertThat(result.artists().get(1).artistName()).isEqualTo("ARTIST_2");
    }
}
