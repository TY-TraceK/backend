...
public class VisitRankingProjectionServiceImpl implements VisitRankingProjectionService {
    ...
    private void increaseArtistLocationRanking(Long locationId, Long artistId) {
                        ...
                        .orElseGet(
                                () ->
                                        artistLocationVisitRankingRepository.save(
                                                ArtistLocationVisitRanking.create(
                                                        locationId, artistId)));

        ranking.increaseVerificationCount();
    }

    private void increaseContentLocationRanking(Long locationId, Long contentId) {
                        ...
                        .orElseGet(
                                () ->
                                        contentLocationVisitRankingRepository.save(
                                                ContentLocationVisitRanking.create(
    ...
    private void decreaseArtistLocationRanking(Long locationId, Long artistId) {
        artistLocationVisitRankingRepository
                .findByLocationIdAndArtistId(locationId, artistId)
                .ifPresent(ArtistLocationVisitRanking::decreaseVerificationCount);
    }

    private void decreaseContentLocationRanking(Long locationId, Long contentId) {
        contentLocationVisitRankingRepository
                .findByLocationIdAndContentId(locationId, contentId)
