...
public class ContentFacade {
    ...
    public ContentDetailResult getContentDetails(Long contentId) {
        ...
        List<Long> artistIds = contentArtistRepository.findArtistIdsByContentId(contentId);
        List<Long> locationIds = episodeQueryRepository.getLocationIdsByContentId(contentId);
