...
public enum VoteErrorCode implements BaseErrorCode {
  ...
  VOTE_TARGET_NOT_FOUND(HttpStatus.NOT_FOUND, "VOTE_002",
      "존재하지 않거나 유효하지 않은 투표 대상(관광지/콘텐츠/아티스트 조합)입니다."),


  DUPLICATE_VOTE(HttpStatus.CONFLICT, "VOTE_003", "해당 관광지에 이미 진행한 유효한 투표가 존재합니다."),
  ...
  CONCURRENT_VOTE_REQUEST(HttpStatus.TOO_MANY_REQUESTS, "VOTE_007",
