...
import com.tracek.domain.ranking.application.service.VisitRankingRelatedQueryService;
...
public class TestController implements TestControllerDocs {
    ...
    private final VisitRankingRelatedQueryService visitRankingRelatedQueryService;
    ...
    public RankingSliceResult<RelatedArtistRankingResult> getArtistsByContent(
        ...
        return visitRankingRelatedQueryService.getArtistsByContent(contentId, condition);
    }
    ...
    public RankingSliceResult<RelatedLocationRankingResult> getLocationsByContent(
        ...
        return visitRankingRelatedQueryService.getLocationsByContent(contentId, condition);
    }

    @GetMapping("/ranking/content/{contentId}/multi")
    public RankingSliceResult<RelatedMultiRankingResult> getMultiRankingByContent(
            @PathVariable Long contentId) {
        return visitRankingRelatedQueryService.getMultiRankingByContent(contentId);
    }
    ...
    public RankingSliceResult<RelatedLocationRankingResult> getLocationsByArtist(
        ...
        return visitRankingRelatedQueryService.getLocationsByArtist(artistId, condition);
    }
    ...
    public RankingSliceResult<RelatedContentRankingResult> getContentsByArtist(
        ...
        return visitRankingRelatedQueryService.getContentsByArtist(artistId, condition);
    }

    @GetMapping("/ranking/artist/{artistId}/multi")
    public RankingSliceResult<RelatedMultiRankingResult> getMultiRankingByArtist(
            @PathVariable Long artistId) {
        return visitRankingRelatedQueryService.getMultiRankingByArtist(artistId);
    }
    ...
    public RankingSliceResult<RelatedArtistRankingResult> getArtistsByLocation(
        ...
        return visitRankingRelatedQueryService.getArtistsByLocation(locationId, condition);
    }
    ...
    public RankingSliceResult<RelatedContentRankingResult> getContentsByLocation(
        ...
        return visitRankingRelatedQueryService.getContentsByLocation(locationId, condition);
    }
    ...
    public RankingSliceResult<RelatedMultiRankingResult> getMultiRankingByLocation(
            @PathVariable Long locationId) {
        return visitRankingRelatedQueryService.getMultiRankingByLocation(locationId);
    }
}
